export const PROJECTS = [
  ...
  {
    name: "29 Points",
    demoLink: "https://diwashdahal.com.np/29points",
    sourceLink: "",
  ...
  },
  {
    ...
    sourceLink: "",
    techs: ["React Native"],
    image: "/assets/img/project/guess.jpg",
    description:
  ...
  },
  {
    ...
    sourceLink: "",
    techs: ["Unity"],
    image: "/assets/img/project/DMD.png",
    description:
      "Drag me down is a game where one must swipe to drag the balloon down so that obstacles don't burst it up.",
  },
  {
    name: "PDF Dark Mode",
    demoLink:
      "https://microsoftedge.microsoft.com/addons/detail/pdf-dark-mode/nghkmkbjhpgdibgopgekgjnbocfmnjdo",
    sourceLink: "https://github.com/diwash007/PDF-Dark-Mode",
    techs: ["HTML", "CSS", "Js"],
